package com.example.lifetotalview;
 ...
 */
@Widget
public class LifeTotalView extends LinearLayout {
     ...
     */
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = R.layout.life_counter;
...
//     */
//    public LifeTotalView(Context context) {
//        this(context, null);
//    }
//
//    /**
...
//
//    public LifeTotalView(Context context, AttributeSet attrs) {
...
//    }
     ...
     */
    public LifeTotalView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.LifeCounterView, defStyle, 0);
//        final int layoutResId = attributesArray.getResourceId(
//                R.styleable.LifeCounterView_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = false;//(layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mSolidColor = attributesArray.getColor(R.styleable.LifeCounterView_solidColor, 0);

        mSelectionDivider = attributesArray.getDrawable(R.styleable.LifeCounterView_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.LifeCounterView_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.LifeCounterView_virtualButtonPressedDrawable);
        ...
        // input text
        mInputText = (EditText) findViewById(R.id.LifeCounterView_input);
